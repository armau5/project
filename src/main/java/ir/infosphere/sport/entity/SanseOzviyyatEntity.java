...
@Entity(name = "sanseozviyyat")
public class SanseOzviyyatEntity extends BaseEntity<Integer> {
	@Id
	@GeneratedValue(strategy = GenerationType.AUTO)
	@Column(name = "ShenaseyeSanseOzviyyat")
	private Integer id;

	@ManyToOne
	@JoinColumn(name = "ShenaseyeOziyyat")
